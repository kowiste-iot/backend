...
func NewWidget(tenantID, branchName, dashboardID, name string, typeWidget byte, i, x, y, w, h int, 
...
func NewWidgetFromRepository(id, tenantID, branchName, dashboardID, name string, typeWidget byte, 
...
func (a *Widget) Update(name string, typeWidget byte, i, x, y, w, h int, widgetData WidgetData) error {
    a.name = name
...
func (a *Widget) Name() string          { return a.name }
